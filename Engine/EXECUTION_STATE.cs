...
{
    /// <summary>
    /// Параметры таймера спящего режима.
    /// Подробнее см. дкументацию: https://docs.microsoft.com/ru-ru/windows/desktop/api/winbase/nf-winbase-setthreadexecutionstate
    /// </summary>
    [Flags]
